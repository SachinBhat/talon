...
def html_fromstring(s):
    ...
    try:
        ...
        return lxml.html.fromstring(s) #html5parser.fromstring(s, parser=_html5lib_parser())
    except Exception:
        pass
...
def html_document_fromstring(s):
    ...
    try:
        ...
        return lxml.html.fromstring(s) #html5parser.document_fromstring(s, parser=_html5lib_parser())
    except Exception:
        pass
